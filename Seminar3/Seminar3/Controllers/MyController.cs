...
namespace Seminar3.Controllers
{
    ...
    public class MyController : ControllerBase
    {
        ...
        public MyController(IProductRepository productRepository, IMemoryCache cache)
        {
        ...
        public class CategoryResponse : ProductEntity
        {
        ...
        public IActionResult ExportProductsToCsv()
        {
            try
            {
                ...
                {
                    csv.AppendLine($"{product.Id},\"{EscapeCsvField(product.Name)}\",\"{EscapeCsvField(product.Description)}\",{product.Price},{product.CategoryId}");
                }
